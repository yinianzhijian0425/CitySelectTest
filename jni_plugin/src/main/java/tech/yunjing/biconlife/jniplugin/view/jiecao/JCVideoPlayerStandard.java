...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    protected static ScheduledExecutorService DISMISS_CONTROL_VIEW_TIMER;
    ...
    @Override
    public void setUp(String url, int screen, FinishPageCallBack callBack, Object... objects) {
        super.setUp(url, screen, callBack, objects);
...
//                Toast.makeText(getContext(), getResources().getString(R.string.no_url), Toast.LENGTH_SHORT).show();
            ...
            callBack.finishCurrentPage(true);
        }
    }

    private boolean isAgree = false;//是否同意流量播放
    ...
    public void startDismissControlViewTimer() {
        cancelDismissControlViewTimer();
        DISMISS_CONTROL_VIEW_TIMER = new ScheduledThreadPoolExecutor(1);
        mDismissControlViewTimerTask = new DismissControlViewTimerTask();
        scheduledFuture = DISMISS_CONTROL_VIEW_TIMER.schedule(mDismissControlViewTimerTask, 2500,TimeUnit.MILLISECONDS);
    }
    ...
    public class DismissControlViewTimerTask implements Runnable {

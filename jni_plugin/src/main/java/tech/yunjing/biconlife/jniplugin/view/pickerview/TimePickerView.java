...
import tech.yunjing.biconlife.jniplugin.view.pickerview.listener.CustomListener;
import tech.yunjing.biconlife.jniplugin.view.pickerview.view.BasePickerView;
import tech.yunjing.biconlife.jniplugin.view.pickerview.view.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (timePickerView == null) {
            // 时间转轮 自定义控件
            timePickerView = (LinearLayout) findViewById(R.id.optionspicker);
        }
        if(timePickerView == null){
            return;
        }

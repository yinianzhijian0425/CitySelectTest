...
public abstract class JCVideoPlayer extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    protected static ScheduledExecutorService UPDATE_PROGRESS_TIMER;
    ...
    private FinishPageCallBack callBack;

    public boolean isFromCourseRunning = false;
    ...
    public void setContext(Context context_, Dialog dialog) {
        this.context = context_;
        this.dialog = dialog;
        manager = (ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE);
    }

    public void setUp(String url_, int screen, FinishPageCallBack callBack, Object... objects) {
        if (!TextUtils.isEmpty(this.url) && TextUtils.equals(this.url, url_)) {
            return;
        }
            ...
            public void run() {
                if (!isCurrentJcvd()) {
                    if (currentState == CURRENT_STATE_NORMAL || currentState == CURRENT_STATE_ERROR) {
                        if (!isFromCourseRunning && !url.startsWith("file") && !JCUtils.isWifiConnected(getContext()) && !WIFI_TIP_DIALOG_SHOWED) {
                            showWifiDialog();
                            return;
                        }
                        prepareMediaPlayer();
    ...
    public void seekToPosition1() {
        if (!JCMediaManager.instance().isPreparing) {
            JCMediaManager.instance().mediaPlayer.start();
            JCMediaManager.instance().mediaPlayer.seekTo(1);
    ...
    public void playNextVideo(String url) {
        LKLogUtil.e("111 playNextVideo url =" + url);
        this.url = url;
        setUiWitStateAndScreen(CURRENT_STATE_NORMAL);
        JCMediaManager.CURRENT_PLAYING_URL = url;
        JCMediaManager.instance().playNext();
    }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.start) {
            ...
            if (currentState == CURRENT_STATE_NORMAL || currentState == CURRENT_STATE_ERROR) {
                ...
                LKLogUtil.e("pauseVideo [" + this.hashCode() + "] ");
                JCMediaManager.instance().mediaPlayer.pause();
            ...
            LKLogUtil.e("onClick fullscreen [" + this.hashCode() + "] ");
            if (currentState == CURRENT_STATE_AUTO_COMPLETE) {
                return;
            }
    ...
    public void prepareMediaPlayer() {
        ...
        LKLogUtil.e("121 prepareMediaPlayer [" + this.hashCode() + "] ");
        initTextureView();
        addTextureView();
        ...
        if (id == R.id.surface_container) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    LKLogUtil.e("onTouch surfaceContainer actionDown [" + this.hashCode() + "] ");
                ...
                case MotionEvent.ACTION_MOVE:
                    LKLogUtil.e("onTouch surfaceContainer actionMove [" + this.hashCode() + "] ");
...
//                        mDownY = y;
                ...
                case MotionEvent.ACTION_UP:
                    LKLogUtil.i("onTouch surfaceContainer actionUp [" + this.hashCode() + "] ");
    ...
    public void addTextureView() {
        LKLogUtil.e("addTextureView [" + this.hashCode() + "] ");
    ...
    public void startProgressTimer() {
        cancelProgressTimer();
        UPDATE_PROGRESS_TIMER = new ScheduledThreadPoolExecutor(1);
        mProgressTimerTask = new ProgressTimerTask();
        scheduledFuture = UPDATE_PROGRESS_TIMER.scheduleAtFixedRate(mProgressTimerTask, 0, 300, TimeUnit.MILLISECONDS);
    ...
    public void cancelProgressTimer() {
        if (UPDATE_PROGRESS_TIMER != null) {
            ...
            UPDATE_PROGRESS_TIMER.shutdown();
        }
    }

    public void onPrepared() {
        LKLogUtil.e("onPrepared " + " [" + this.hashCode() + "] ");
    ...
    public void onAutoCompletion() {
        ...
        LKLogUtil.e("onAutoCompletion " + " [" + this.hashCode() + "] ");
...
//        }
        ...
        if (callBack != null) {
            callBack.finishCurrentPage(false);
        }
        if (mOnVideoListener != null) {
            mOnVideoListener.onFinish();
        }
    }

    public void onCompletion() {
        LKLogUtil.e("onCompletion " + " [" + this.hashCode() + "] ");
        //save position
...
//        JCMediaManager.textureView = null;
    ...
    public void playOnThisJcvd() {
        LKLogUtil.e("playOnThisJcvd " + " [" + this.hashCode() + "] ");
        //1.清空全屏和小窗的jcvd
...
//        secJcvd.onCompletion();
    ...
    public void onError(int what, int extra) {
        LKLogUtil.e("onError " + what + " - " + extra + " [" + this.hashCode() + "] ");
        if (what != 38 && what != -38) {
    ...
    public void onInfo(int what, int extra) {
        LKLogUtil.e("onInfo what - " + what + " extra - " + extra);
        if (what == MediaPlayer.MEDIA_INFO_BUFFERING_START) {
            ...
            LKLogUtil.e("MEDIA_INFO_BUFFERING_START");
        } else if (what == MediaPlayer.MEDIA_INFO_BUFFERING_END) {
            if (BACKUP_PLAYING_BUFFERING_STATE != -1) {
                setUiWitStateAndScreen(BACKUP_PLAYING_BUFFERING_STATE);
                BACKUP_PLAYING_BUFFERING_STATE = -1;
            }
            LKLogUtil.e("MEDIA_INFO_BUFFERING_END");
        }
    }

    public void onVideoSizeChanged() {
        LKLogUtil.e("onVideoSizeChanged " + " [" + this.hashCode() + "] ");
    ...
    public void onStartTrackingTouch(SeekBar seekBar) {
        LKLogUtil.e("bottomProgress onStartTrackingTouch [" + this.hashCode() + "] ");
        cancelProgressTimer();
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        LKLogUtil.e("bottomProgress onStopTrackingTouch [" + this.hashCode() + "] ");
        ...
        LKLogUtil.e("seekTo " + time + " [" + this.hashCode() + "] ");
    }
    ...
    public void startWindowFullscreen() {
        LKLogUtil.e("startWindowFullscreen " + " [" + this.hashCode() + "] ");
...
//        ((ViewGroup)JCMediaManager.textureView.getParent()).removeView(JCMediaManager.textureView);
        ...
        try {
            ...
            jcVideoPlayer.setUp(url, JCVideoPlayerStandard.SCREEN_WINDOW_FULLSCREEN, callBack, objects);
...
//            jcVideoPlayer.setAnimation(ra);
    ...
    public void startWindowTiny() {
        LKLogUtil.e("startWindowTiny " + " [" + this.hashCode() + "] ");
        ...
        try {
            ...
            vp.addView(jcVideoPlayer, lp);
            jcVideoPlayer.setUp(url, JCVideoPlayerStandard.SCREEN_WINDOW_TINY, callBack, objects);
            jcVideoPlayer.setUiWitStateAndScreen(currentState);
            jcVideoPlayer.addTextureView();
            JCVideoPlayerManager.setSecondFloor(jcVideoPlayer);
        ...
        public void onAudioFocusChange(int focusChange) {
            switch (focusChange) {
                ...
                case AudioManager.AUDIOFOCUS_LOSS:
                    releaseAllVideos();
                    LKLogUtil.e("AUDIOFOCUS_LOSS [" + this.hashCode() + "]");
                    break;
                case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT:
                    ...
                    LKLogUtil.e("AUDIOFOCUS_LOSS_TRANSIENT [" + this.hashCode() + "]");
                    break;
    ...
    public void release() {
        if (url.equals(JCMediaManager.CURRENT_PLAYING_URL) &&
            ...
            if (JCVideoPlayerManager.getSecondFloor() != null &&
                ...
                LKLogUtil.e("release [" + this.hashCode() + "]");
                releaseAllVideos();
            }
        }
    }
...
//    }
    ...
    public static void startFullscreen(Context context, Class aClass, String url, Object... objects) {
        ...
        try {
            Constructor<JCVideoPlayer> constructor = aClass.getConstructor(Context.class);
...
//            jcVideoPlayer.setAnimation(ra);
            jcVideoPlayer.setUp(url, JCVideoPlayerStandard.SCREEN_WINDOW_FULLSCREEN, null, objects);
            CLICK_QUIT_FULLSCREEN_TIME = System.currentTimeMillis();
...
//        startButton.setClickable(false);
    ...
    public void setOnVideoListener(OnVideoListener mOnVideoListener) {
        this.mOnVideoListener = mOnVideoListener;
    }

    public void solveActivityBack() {
        JCMediaManager.instance().isActivityOnBackground = true;
        LKLogUtil.e("111 current state " + currentState);
        if (currentState == CURRENT_STATE_NORMAL || currentState == CURRENT_STATE_ERROR) {
            LKLogUtil.e("111 solveActivityBack normal or error");
        } else if (currentState == CURRENT_STATE_PLAYING || currentState == CURRENT_STATE_PLAYING_BUFFERING_START) {
            LKLogUtil.e("111 solveActivityBack playing");
            onEvent(JCUserAction.ON_CLICK_PAUSE);
            JCMediaManager.instance().mediaPlayer.pause();
            setUiWitStateAndScreen(CURRENT_STATE_PAUSE);
        } else if (currentState == CURRENT_STATE_PAUSE) {
            LKLogUtil.e("111 solveActivityBack pause");
        } else if (currentState == CURRENT_STATE_AUTO_COMPLETE) {
            LKLogUtil.e("111 solveActivityBack complete");
        }
    }

    public void sovleActivityFore() {
        LKLogUtil.e("116 sovleActivityFore state = " + currentState);
        JCMediaManager.instance().isActivityOnBackground = false;
        if (currentState == CURRENT_STATE_NORMAL
            ...
            JCMediaManager.instance().mediaPlayer.pause();
            JCMediaManager.instance().mediaPlayer.start();
        } else if (currentState == CURRENT_STATE_PAUSE || currentState == CURRENT_STATE_PLAYING_BUFFERING_START) {
            onEvent(JCUserAction.ON_CLICK_START_ICON);
            JCMediaManager.instance().mediaPlayer.start();

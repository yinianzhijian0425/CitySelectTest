...
public class FormatUtil {
    ...
    private static final String ID_CARD_PATTERN ="(\\d{14}[0-9a-zA-Z])|(\\d{17}[0-9a-zA-Z])";
    ...
    public static boolean isIdCardNo(String idNum) {
        ...
        Pattern idNumPattern = Pattern.compile(ID_CARD_PATTERN);
        //通过Pattern获得Matcher
    ...
    public static boolean IDCardValidate(String IDStr) throws ParseException {
        ...
        if (IDStr.length() != 15 && IDStr.length() != 18) {
            ...
            LKLogUtil.e("ID:" + "errorInfo=" + errorInfo);
            return false;
        }
        // =======================(end)========================

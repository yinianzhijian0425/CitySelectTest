 ...
 * On 2016/06/02 00:01
 */
class JCResizeTextureView extends TextureView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        LKLogUtil.e("onMeasure " + " [" + this.hashCode() + "] ");
        int viewRotation = (int) getRotation();
        int videoWidth = mVideoSize.x;
        int videoHeight = mVideoSize.y;
        LKLogUtil.e("videoWidth = " + videoWidth + ", " + "videoHeight = " + videoHeight);
        LKLogUtil.e("viewRotation = " + viewRotation);
        ...
        if (videoWidth > 0 && videoHeight > 0) {
            ...
            LKLogUtil.e("widthMeasureSpec  [" + MeasureSpec.toString(widthMeasureSpec) + "]");
            LKLogUtil.e("heightMeasureSpec [" + MeasureSpec.toString(heightMeasureSpec) + "]");

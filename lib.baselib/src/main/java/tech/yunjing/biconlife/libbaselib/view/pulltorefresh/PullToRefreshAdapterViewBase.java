...
import tech.yunjing.biconlife.libbaselib.view.pulltorefresh.internal.EmptyViewMethodAccessor;
import tech.yunjing.biconlife.libbaselib.view.pulltorefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
    ...
    public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
        ...
        if (DEBUG) {
            LKLogUtil.e(LOG_TAG + "First Visible: " + firstVisibleItem + ". Visible Count: " + visibleItemCount
    ...
    private boolean isLastItemVisible() {
        ...
        if (null == adapter || adapter.isEmpty()) {
            ...
            if (DEBUG) {
                LKLogUtil.e(LOG_TAG + "isLastItemVisible. Last Item Position: " + lastItemPosition + " Last Visible Pos: "
                        + lastVisiblePosition);
            }

...
/**
 * 自定义ListView继承SwipeRefreshLayout，添加上拉加载更多的布局属性,添加对RecyclerView的支持
 * Created by sun.li on 2017/7/18.
 * ①、只可以嵌套ListView
 */
public class BCSlideSwipeRefreshListView extends SwipeRefreshLayout {

    private static final String TAG = BCSlideSwipeRefreshListView.class.getSimpleName();
    ...
    public BCSlideSwipeRefreshListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        // 填充底部加载布局
        mFooterView = View.inflate(context, R.layout.bc_listview_footer, null);

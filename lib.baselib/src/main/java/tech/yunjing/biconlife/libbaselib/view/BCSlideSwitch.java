...
import tech.yunjing.biconlife.libbaselib.util.ColorUtil;


/**
 * 自定义开关按钮
 */
public class BCSlideSwitch extends CompoundButton {
    public static final float DEFAULT_BACK_MEASURE_RATIO = 1.9f;
    ...
    public BCSlideSwitch(Context context, AttributeSet attrs, int defStyle) {
   ...
   public   void setColor(int tumbDrawable,int backDrawable){
       setThumbDrawable(ContextCompat.getDrawable(getContext(),tumbDrawable));
       setBackDrawableRes(backDrawable);
//       setThumbDrawable(ContextCompat.getDrawable(getContext(), R.drawable.selector_tumb_drawable));
//       setBackDrawableRes(R.drawable.selector_back_drawable);
       invalidate();

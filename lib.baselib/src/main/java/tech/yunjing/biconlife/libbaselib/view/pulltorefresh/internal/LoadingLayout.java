 ...
 *******************************************************************************/
package tech.yunjing.biconlife.libbaselib.view.pulltorefresh.internal;
...
import tech.yunjing.biconlife.libbaselib.view.pulltorefresh.ILoadingLayout;
import tech.yunjing.biconlife.libbaselib.view.pulltorefresh.PullToRefreshBase;
	...
	public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
		...
		switch (mode) {
			case PULL_FROM_END:
				...
				// Load in labels
				mPullLabel = context.getString(R.string.pull_to_refresh_pull_label_more);
				mRefreshingLabel = context.getString(R.string.pull_to_refresh_refreshing_label);
				mReleaseLabel = context.getString(R.string.pull_to_refresh_release_label_more);
				break;

package tech.yunjing.biconlife.libbaselib.view.dropdownview;
...
public class DropDownMenu extends LinearLayout {
    ...
    public void setDropDownMenu(@NonNull List<String> tabTexts, @NonNull List<View> popupViews, @NonNull View contentView) {
        ...
        popupMenuViews.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) (BCDeviceUtils.getScreenSize(getContext()).y * menuHeighPercent)));

...
import tech.yunjing.biconlife.liblkclass.bitmap.ImageManagerImpl;
import tech.yunjing.biconlife.liblkclass.common.TaskController;
import tech.yunjing.biconlife.liblkclass.common.task.TaskControllerImpl;
import tech.yunjing.biconlife.liblkclass.db.DbManagerImpl;
import tech.yunjing.biconlife.liblkclass.http.xhttp.HttpManagerImpl;
import tech.yunjing.biconlife.liblkclass.view.ViewInjectorImpl;


/**
 * 任务控制中心, http, image, db, view注入等接口的入口.
 * 需要在在application的onCreate中初始化: LK.Ext.init(this);
 */
    ...
    public static Application app() {
        if (Ext.app == null) {
            try {
                ...
                throw new RuntimeException("please invoke LK.Ext.init(app) on Application#onCreate()"

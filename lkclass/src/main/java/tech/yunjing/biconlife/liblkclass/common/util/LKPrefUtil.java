...
public class LKPrefUtil {
	 ...
	 * @param objects
	 */
	public static Object getObjectJSON(String key,Class objects){
		try {
			Object o = null;
			String result = LKPrefUtil.getString(key,"");
			if ("".equals(result)){
				return null;
			}
			o = new Gson().fromJson(result,objects);
			return o;
		}catch (Exception e){
			e.printStackTrace();
			return null;

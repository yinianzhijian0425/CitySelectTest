...
import tech.yunjing.biconlife.liblkclass.http.xhttp.body.ProgressBody;
import tech.yunjing.biconlife.liblkclass.http.xhttp.body.RequestBody;
import tech.yunjing.biconlife.liblkclass.http.xhttp.cookie.DbCookieStore;
...
public class HttpRequest extends UriRequest {
    ...
    protected String buildQueryUrl(RequestParams params) {
        ...
        if (!uri.contains(judgeStr)) {
            queryBuilder.append(judgeStr);
        } else if (!uri.endsWith(judgeStr)) {
            queryBuilder.append("&");
        }
    ...
    public void sendRequest() throws Throwable {
        ...
        if (responseCode == 204 || responseCode == 205) { // empty content
            ...
            LKLogUtil.e(httpException.toString() + ", url: " + queryUrl);
            throw httpException;
        }

...
import tech.yunjing.biconlife.liblkclass.common.util.DoubleKeyValueMap;
                ...
                if (method != null) {
                    ...
                    if (AVOID_QUICK_EVENT_SET.contains(eventMethod)) {
                        ...
                        if (timeSpan < QUICK_EVENT_TIME_SPAN) {
                            LKLogUtil.d("onClick cancelled: " + timeSpan);
                            return null;
                        }
                    ...
                    LKLogUtil.w("method not impl: " + eventMethod + "(" + handler.getClass().getSimpleName() + ")");
                }
            }
            return null;
        }

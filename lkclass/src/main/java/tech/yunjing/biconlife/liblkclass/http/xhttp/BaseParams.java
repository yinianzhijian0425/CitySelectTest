...
import tech.yunjing.biconlife.liblkclass.common.util.KeyValue;
import tech.yunjing.biconlife.liblkclass.common.util.LKLogUtil;
import tech.yunjing.biconlife.liblkclass.http.xhttp.body.BodyItemWrapper;
import tech.yunjing.biconlife.liblkclass.http.xhttp.body.FileBody;
import tech.yunjing.biconlife.liblkclass.http.xhttp.body.InputStreamBody;
import tech.yunjing.biconlife.liblkclass.http.xhttp.body.MultipartBody;
import tech.yunjing.biconlife.liblkclass.http.xhttp.body.RequestBody;
import tech.yunjing.biconlife.liblkclass.http.xhttp.body.StringBody;
import tech.yunjing.biconlife.liblkclass.http.xhttp.body.UrlEncodedParamsBody;
 ...
 */
 abstract class BaseParams {
            ...
            if (!multipart && fileParams.size() == 1) {
                for (KeyValue kv : fileParams) {
                    ...
                    if (value instanceof File) {
                        ...
                        LKLogUtil.e("Some params will be ignored for: " + this.toString());
                    }
                    break;
                }
            } else {
    ...
    private void checkBodyParams() {
        ...
        boolean judge = !bodyParams.isEmpty() && (multipart || fileParams.size() > 0);
        if (judge) {

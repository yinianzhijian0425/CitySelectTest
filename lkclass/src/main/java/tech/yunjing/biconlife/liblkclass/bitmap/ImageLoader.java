...
import tech.yunjing.biconlife.liblkclass.cache.LruCache;
import tech.yunjing.biconlife.liblkclass.cache.LruDiskCache;
...
/*package*/ final class ImageLoader implements
    ...
    static {
        int memClass = ((ActivityManager) LK.app()
    ...
    static Cancelable doLoadFile(final String url,
        ...
        return LK.http().get(params, callback);
    }
            ...
            try {
                ...
                if (trustMemCache && callback != null) {
                    try {
                        ...
                        LKLogUtil.e(ignored.getMessage(), ignored);
                    }
                }
            }
        } else {
    ...
    private Cancelable doLoad(ImageView view,
        ...
        return cancelable = LK.http().get(params, this);
    }
    ...
    public void onSuccess(Drawable result) {
        if (!validView4Callback(!hasCache)) {
            return;
        }
    ...
    public void onError(Throwable ex, boolean isOnCallback) {
        ...
        if (ex instanceof FileLockedException) {
            LKLogUtil.d("ImageFileLocked: " + key.url);
            LK.task().postDelayed(new Runnable() {
                @Override
                public void run() {

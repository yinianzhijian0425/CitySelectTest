package tech.yunjing.biconlife.liblkclass.common.task;
...
import tech.yunjing.biconlife.liblkclass.common.Callback.CancelledException;
            ...
            try {
                switch (msg.what) {
                    ...
                    case MSG_WHAT_ON_ERROR: {
                        ...
                        LKLogUtil.d(throwable.getMessage(), throwable);
